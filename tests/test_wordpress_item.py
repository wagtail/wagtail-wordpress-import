...
from src.wagtail_wordpress_import.importers.wordpress import (
    DEFAULT_PREFILTERS,
    WordpressImporter,
    WordpressItem,
)
from src.wagtail_wordpress_import.logger import Logger
...
@override_settings(
    ...
    WAGTAIL_WORDPRESS_IMPORT_CATEGORY_PLUGIN_MODEL="tests.models.Category",
...
class TestWordpressItemPrefilterOverride(TestCase):
    ...
    @override_settings(
        WAGTAIL_WORDPRESS_IMPORT_PREFILTERS=[
            {"FUNCTION": "tests.test_wordpress_item.foo_filter"}
        ]
    )
                ...
                "OPTIONS": {
                    "TRANSFORM_STYLES_MAPPING": [
                        (
                            ...
                            "tests.test_wordpress_item.transform_foo",
                        )
                    ],
                },
            },
